...
def load_checkpoint_model(checkpoint_path):
    ...
    loaded_model = TFAutoModelForSequenceClassification.from_pretrained(latest_checkpoint_file, config=config)
    # FAutoModelForSequenceClassification.from_pretrained
